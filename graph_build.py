...
def main():
    ...
    graph.load_movies('file:///normalized_data/normalized_movies.csv', movie_limit)

    # Load related nodes and create relationships conditionally
    graph.load_genres('file:///normalized_data/normalized_genres.csv')
    graph.load_production_companies('file:///normalized_data/normalized_production_companies.csv')
    graph.load_production_countries('file:///normalized_data/normalized_production_countries.csv')
    graph.load_spoken_languages('file:///normalized_data/normalized_spoken_languages.csv')
    graph.load_keywords('file:///normalized_data/normalized_keywords.csv')
    graph.load_person_actors('file:///normalized_data/normalized_cast.csv')
    graph.load_person_crew('file:///normalized_data/normalized_crew.csv')
    graph.load_links('file:///normalized_data/normalized_links.csv')
    graph.load_ratings('file:///normalized_data/normalized_ratings_small.csv')
